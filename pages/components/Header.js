              ...
              <div className="md:flex md:items-center md:gap-8">
                <nav aria-label="Global" className="hidden md:block">
                  <ul className="flex items-center gap-3 text-lg">
                    ...
                    <li>
                      <Link className={pathname === '/branded' ? active : inActive} href="/branded">
                        Brand
                      </Link>
                    </li>
                    <li>
                      <Link className={pathname === '/satuan-produk' ? active : inActive} href="/satuan-produk">
                        Satuan
                      </Link>
                    </li>
                    {/* <li>
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* Mobile navigation button */}
                  <div className="block md:hidden">
                    <button onClick={toggleMobileNav} className="rounded bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75">
                      {isMobileNavOpen ? (
                        // X icon for close
                  ...
                  {isMobileNavOpen && (
                    <div className="md:hidden absolute top-16 right-0 bg-white border border-zinc-200 rounded shadow-lg p-6 text-lg">
                      <ul className="flex flex-col items-start gap-4">
                        <li>
                          <Link onClick={toggleMobileNav} className={pathname === '/' ? active : inActive} href="/">
                            Dashboard
                          </Link>
                        </li>
                        <li>
                          <Link onClick={toggleMobileNav} className={pathname === '/products' ? active : inActive} href="/products">
                            Products
                          </Link>
                        </li>
                        <li>
                          <Link onClick={toggleMobileNav} className={pathname === '/categories' ? active : inActive} href="/categories">
                            Categories
                          </Link>
                        </li>
                        <li>
