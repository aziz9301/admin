...
export default function Product({
    ...
    async function createProduct(ev) {
        ...
        const data = { title, description, price, details, images, category, brand, stock,  isi, date };
        if (_id) {
                ...
                <div className="grid grid-cols-2 items-center my-4">
                    ...
                    <div className="col-span-2">
                        <select
                            ...
                            onChange={(ev) => setType(ev.target.value)}
                        >
                            <option value="">Select Satuan Produk</option>
                            {satuanProduk.map((satuan) => (
                                <option key={satuan._id} value={satuan.name}>
                                    {satuan.name}
                                </option>
                            ))}
                        </select>
